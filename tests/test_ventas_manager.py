...
def test_registrar_venta_staff_invalido(db_conectada: DBManager, generador_datos: GeneradorDatos, ventas_manager: VentasManager, pasajeros_manager: TablaManager, vuelos_manager: VuelosManager, rutas: list[RutaDesdeDB], aviones: list[AvionDesdeDB], id_staff: int) -> None:
    registrar_pasajeros(generador_datos, pasajeros_manager, 1, id_staff)
    registrar_vuelos(generador_datos, vuelos_manager, 1, rutas, aviones, id_staff)
...
def test_modificar_venta_estado_correcto(db_conectada: DBManager, generador_datos: GeneradorDatos, ventas_manager: VentasManager, pasajeros_manager: TablaManager, vuelos_manager: VuelosManager, rutas: list[RutaDesdeDB], aviones: list[AvionDesdeDB], id_staff: int) -> None:
    registrar_pasajeros(generador_datos, pasajeros_manager, 1, id_staff)
    registrar_vuelos(generador_datos, vuelos_manager, 1, rutas, aviones, id_staff)
...
def test_modificar_venta_estado_invalido(db_conectada: DBManager, generador_datos: GeneradorDatos, ventas_manager: VentasManager, pasajeros_manager: TablaManager, vuelos_manager: VuelosManager, rutas: list[RutaDesdeDB], aviones: list[AvionDesdeDB], id_staff: int) -> None:
    registrar_pasajeros(generador_datos, pasajeros_manager, 1, id_staff)
    registrar_vuelos(generador_datos, vuelos_manager, 1, rutas, aviones, id_staff)
