...
def test_to_dict_method(booking: Booking) -> None:
    ...
    assert dict_booking["id"] == UUID("019e92b3-e0db-7244-a9a2-43322a076e75")
    assert dict_booking["booking_reference"] == "ABC123"
    assert dict_booking["booking_datetime"] == datetime(2026, 1, 1)
    assert dict_booking["paid_amount_usd"] == Decimal("10000.76")
    assert dict_booking["current_status_id"] == 1
